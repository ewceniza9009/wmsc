  ...
  const features = [
    {
      ...
      description:
        "Monitor and maintain precise temperature conditions for sensitive cold storage products with real-time alerts and historical data tracking for quality assurance.",
    ...
    },
    {
      ...
      description:
        "Track stock levels, manage product locations, and optimize cold storage space with advanced algorithms that reduce waste and improve efficiency.",
    ...
    },
    {
      title: "Traceability",
      description:
        "Maintain complete chain of custody and temperature history for regulatory compliance with detailed audit trails and automated documentation.",
    ...
    },
    {
      ...
      description:
        "Optimize power consumption with smart cooling systems that adjust based on inventory levels and external conditions, reducing operational costs.",
    ...
    },
    {
      title: "Mobile Access",
      description:
        "Control your cold storage operations from anywhere with secure mobile applications that provide real-time monitoring and management capabilities.",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900">
      ...
      <main className="container mx-auto px-4 py-4">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-16 gap-8 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-teal-700 dark:text-teal-400">
              Warehouse Management on Cold Storage
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-300">
              Streamline your temperature-controlled inventory, optimize
              operations, and ensure compliance with our comprehensive cold
              storage warehouse management solution.
            </p>
        ...
        >
          <section>
            <h2 className="text-3xl font-bold text-center mb-12 text-teal-700 dark:text-teal-400">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Continuous monitoring with alerts for temperature deviations
                  to protect sensitive inventory.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Maintain temperature integrity throughout the entire supply
                  chain process.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Automated documentation and reporting for regulatory
        ...
        >
          <h2 className="text-3xl font-bold text-center mb-12 text-teal-700 dark:text-teal-400">
            Advanced Cold Storage Features
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            <motion.div
              whileHover={{ y: -10 }}
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Monitor inventory movements and status updates in real-time
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Enterprise-grade security features and compliance with industry
                regulations for cold storage.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Comprehensive data analysis and reporting tools to optimize your
        ...
        >
          <div className="container mx-auto px-4">
            <h2 className="text-2xl font-bold text-center mb-8 text-teal-700 dark:text-teal-400">
              Trusted by Cold Chain Leaders
            </h2>
        ...
        >
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 max-w-3xl mx-auto">
              Join hundreds of businesses that have optimized their warehouse
              management with our specialized cold storage solution.
            </p>
            <motion.div
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
      ...
      <footer className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-lg font-bold text-teal-700 dark:text-teal-500">
                  WMS Cold Storage
                </span>
              </div>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Comprehensive warehouse management solution for
                temperature-controlled environments.
              </p>
            </div>

            <div>
              <h3 className="font-semibold text-lg mb-4 text-teal-700 dark:text-teal-500">
                Features
              </h3>
          ...
          <div className="pt-8 border-t border-gray-200 dark:border-gray-700 text-center text-gray-500 dark:text-gray-400">
            <p>
              © {new Date().getFullYear()} WMS Cold Storage. All rights
              reserved.
            </p>
          </div>
        </div>
